...
> 🧠 **RAG / base de conocimiento normativo — Fase 1 ✅ ACTIVA (2026-06-29):** pgvector + `kb_chunks` + RPC `match_kb` aplicados; EF `kb-ask` desplegada; tab "⚖️ Consulta normativa" funcionando y verificado end-to-end. Embeddings con `gemini-embedding-001` (768d). **Corpus global ingestado (1644 fragmentos, 7 normas, todas vigentes):** EBEP (extracto Art.48/50), Ley 15/2010 Autoridad del Profesorado (CV), Ley 26/2018 Infancia y Adolescencia (CV), Decreto 233/2004 Observatorio Convivencia (CV), Decreto 193/2025 Convivencia en el sistema educativo (CV), LO 8/2021 LOPIVI, LO 3/2018 LOPDGDD. Fuentes BOE vía XML consolidado (`scripts/_fetch_boe.mjs`) + DOGV (PDF, `pdf-parse` v2). **Próximos pasos:** (1) ampliar corpus (EBEP/LOMLOE completos, NOF de cada centro en `docs/normativa/centro/<slug>/`); (2) **Fase 2**: conectar el RAG al copiloto de RRHH e incidencias para que citen artículos reales; (3) **Fase 3**: ingesta desde el módulo Documentos + control de vigencia. Plan completo en **@CLAUDE-ROADMAP.md → "🧠 RAG / Base de conocimiento normativo"**.
