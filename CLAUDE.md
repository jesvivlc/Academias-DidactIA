...
> - ⚠️ `supabase/migrations/calificaciones_familia_rls.sql` — **fix de privacidad RGPD**: restringe `cal_read` para que las familias solo lean las notas de sus hijos (hoy leen las de TODO el centro). Aplicar cuanto antes.
>
