# DidactIA Academias — Archivo histórico del roadmap

> ⚠️ **NO referenciar este archivo con `@` desde CLAUDE.md ni pedir que se lea al arrancar.**
> Su propósito es preservar el histórico SIN que se cargue en cada sesión.
>
> Contenido: el resumen de cierre del backlog, la construcción inicial (fases 1–6), el estado
> por fases y los 28 incrementos del registro, todos ya completados, desplegados y verificados
> en producción. Consultar a mano solo para rastrear una decisión pasada.
>
> Rotado desde `docs/ROADMAP-PROGRESO.md` el 2026-07-21. Contenido movido **verbatim**, sin editar.

---

## [Archivado 2026-07-21] Cabecera original del fichero

> La contraseña que aparece aquí ya está rotada y la cuenta demo pública es otra;
> se conserva solo por fidelidad al original.
...
## [Archivado 2026-07-21] Resumen final del backlog y pasos pendientes de entonces
...
## [Archivado 2026-07-21] Construcción inicial, estado por fases y registro de incrementos
